    ...
    <div className="bg-[#022C22] min-h-screen font-sans text-white overflow-x-hidden">
      ...
      <section className="py-24 px-4 md:px-12 bg-[#022C22] relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="md:w-1/2 relative">
            ...
            {/* The Main Frame (keeping your original size & rotation) */}
            <div className="relative bg-white/5 border border-white/10 p-2 rounded-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500 shadow-2xl">
              ...
              {/* CSS for Image to suit the Frame */}
              <div className="h-[300px] md:h-[400px] w-full rounded-xl overflow-hidden relative">
                <img
                  src={farmingImg}
                  alt="TJP Mushroom Farming"
                  className="w-full h-full object-cover object-center transition-transform duration-700 hover:scale-110"
                  style={{
                    filter: 'contrast(1.1) brightness(0.9)', // Image frame-ku suit aaga chinna editing
                    display: 'block'
                  }}
                />

                {/* Subtle overlay to match your theme color #022C22 */}
                <div className="absolute inset-0 bg-[#022C22]/10 pointer-events-none"></div>
              </div>
      ...
      <section className="py-24 bg-[#022C22] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          {/* --- GOOGLE REVIEWS LINK UPDATED --- */}
          <div className="flex justify-center mt-12">
            <a
              href="https://search.google.com/local/writereview?placeid=ChIJR8PG7wvtADsRA-RJnAOze5c"
              rel="noopener noreferrer"
              className="group flex items-center gap-3 bg-white/5 border border-white/10 px-8 py-4 rounded-2xl hover:bg-tjp-gold hover:text-black transition-all duration-500 shadow-xl"
            >
              {/* Google Icon */}
              ...
              <span className="font-black tracking-tight text-lg uppercase">Write a Review on Google</span>
